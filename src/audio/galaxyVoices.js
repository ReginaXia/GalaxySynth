...
export function createGalaxyVoices() {
  ...
  function createCosmicSynthVoice() {
    return createLayeredVoice({
      transientOsc: "sine",
      transientEnv: { attack: 0.010, decay: 0.050, sustain: 0.0, release: 0.08 },
      transientVol: -17.0,
      coreOsc: "sine",
      coreEnv: { attack: 0.055, decay: 0.55, sustain: 0.24, release: 1.35 },
      coreVol: -11.5,
      coreDetune: -2,
      enableSaw: true,
      coreSawVol: -25.5,
      ...
      fmCarrierOsc: "sine",
      fmModOsc: "sine",
      fmEnv: { attack: 0.04, decay: 0.30, sustain: 0.12, release: 1.0 },
      fmModEnv: { attack: 0.03, decay: 0.22, sustain: 0.0, release: 0.40 },
      fmVol: -24.5,
      bellOsc: "sine",
      bellEnv: { attack: 0.03, decay: 0.24, sustain: 0.0, release: 0.45 },
      bellVol: -29.0,
      airOsc: "triangle",
      airEnv: { attack: 0.012, decay: 0.11, sustain: 0.0, release: 0.24 },
      airVol: -25.0,
      transientHP: 2800,
      transientLP: 11500,
      coreHP: 180,
      ...
      airHalo: 0.62,
      coreDurMul: 1.30,
      transientDurMul: 0.23,
      airDurMul: 0.42,
      transientVelMul: 0.25,
      coreVelMul: 0.85,
      fmVelMul: 0.16,
      bellVelMul: 0.0,
      airVelMul: 0.18,
